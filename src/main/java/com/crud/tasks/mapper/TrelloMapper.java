...
public class TrelloMapper {
    ...
    public CreatedTrelloCardDto mapToNewCardDto(final CreatedTrelloCardDto createdTrelloCardDto) {
        return new CreatedTrelloCardDto(createdTrelloCardDto.getName(), createdTrelloCardDto.getId(), createdTrelloCardDto.getShortUrl() );
    }
